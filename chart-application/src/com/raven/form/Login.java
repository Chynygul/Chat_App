...
public class Login extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbEmailLogin.setText("Email:");
        lbEmailLogin.setFont(new java.awt.Font("sansserif", 0, 14));
        lbEmailLogin.setForeground(new java.awt.Color(66, 66, 66));

        txtEmailLogin.setFont(new java.awt.Font("sansserif", 0, 14));
        txtEmailLogin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 200, 200)));
        txtEmailLogin.setBackground(new java.awt.Color(245, 245, 245));
